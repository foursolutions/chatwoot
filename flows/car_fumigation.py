...
def send_pest_control_list(to: str, phone_number_id: str):
    ...
    Row IDs must match what dispatcher checks (e.g. "car_fumigation").
    """
    payload = {
        "to": to,
        "type": "interactive",
...
def send_car_fum_quote_options(to: str, phone_number_id: str):
    """
    Sends the `car_fum_quote_options` template with button IDs:
       - "car_fum_book"
       - "car_fum_info"
       - "return_main_menu"
    """
...
def send_car_fum_appointment_method(to: str, phone_number_id: str):
    """
    Sends the `car_fum_appointment_method` template with:
       - "car_fum_asap"
       - "car_fum_schedule"
    """
...
# =============================================================================
# 6) Car Fumigation Quote Summary → `car_fum_appointment_confirmation`
# =============================================================================
def send_car_fum_quote_summary(to: str, phone_number_id: str,
    ...
    Template name: "car_fum_appointment_confirmation"
    Buttons: "car_fum_confirm_yes", "car_fum_confirm_no"
    """
    params = [
    ...
    # Only pass the raw strings to send_template_message
    send_template_message(
        to,
...
# ============================================================
# 10) Quote Calculation (Placeholder logic)
# ============================================================
def calculate_quote(state: dict) -> float:
    """
    Placeholder quote logic. You can replace with real pricing logic.
    Example: base fee + surcharges based on pest, vehicle type, location.
    """
    base = 50.0
