...
# Admin phone numbers and dynamic target mapping
...
def handle_interactive_message(
    ...
    if sender_number in ADMIN_NUMBERS and button_id and button_id.startswith("admin_"):
        ...
        if button_id == "admin_cfum_confirm":
            ...
            send_text_message(
                ...
                "* Cash: Please inform us in advance and prepare the exact amount."
            )
    ...
    if list_id and list_id.startswith("location_"):
        ...
        return
    if list_id and list_id.startswith("cfq_"):
    ...
    if list_id and list_id.startswith("bedroom_count_"):
        ...
        return
    if list_id and list_id.startswith("bathroom_count_"):
...
def send_admin_command_menu(admin_number, send_text_message):
    """
    Show the admin command menu as an interactive message.
    """
    # For best practice, this should actually use send_interactive_message.
    # Here is a placeholder for clarity.
